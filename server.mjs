...
const obj_diff_match_patch = new diff_match_patch()
            ...
            case "/sync":
                ...
                try {
                    ...
                    for (const n_and_patches of json.stack) {
                        ...
                        text1 = obj_diff_match_patch.patch_apply(n_and_patches.patches, text1)[0]
...
console.log(`Listening on http://${localIp || server.hostname}:${server.port}`);